...
![](convergenceRatesImbalancedSmallSigma_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
if(FALSE)
{
  ...
  save(result, file="resultRatesImbalancedSmallSigma.Rda")
}
```
...
``` r
load("resultRatesImbalancedSmallSigma.Rda")
...
![](convergenceRatesImbalancedSmallSigma_files/figure-markdown_github/unnamed-chunk-7-1.png)

``` r
pE + theme_bw()
```

![](convergenceRatesImbalancedSmallSigma_files/figure-markdown_github/unnamed-chunk-7-2.png)
...
![](convergenceRatesImbalancedSmallSigma_files/figure-markdown_github/unnamed-chunk-8-1.png)

``` r
pE + theme_bw()
```

![](convergenceRatesImbalancedSmallSigma_files/figure-markdown_github/unnamed-chunk-8-2.png)
